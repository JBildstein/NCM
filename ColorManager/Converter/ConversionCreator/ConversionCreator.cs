...
namespace ColorManager
{
    ...
    {
        protected abstract class ConversionCreator
        {
            #region Variables
            ...
            /// <param name="inColor">The input color</param>
            /// <param name="outColor">The output color</param>
            protected ConversionCreator(ConversionCreator parent, Color inColor, Color outColor, bool isFirst, bool isLast)
            {
